...
object stream_processing_app {
  def main(args: Array[String]): Unit = {
    ...
    val mysql_password = "admin"
    val mysql_database_name = "meetup_db"
    val mysql_driver_class = "com.mysql.jdbc.Driver"
    val mysql_table_name = "meetup_rsvp_table"
    ...
    meetup_rsvp_df_4.createOrReplaceTempView("meetup_rsvp_df_4")

    val meetup_rsvp_df_5 = spark.sql("SELECT * FROM meetup_rsvp_df_4 WHERE group_city = 'Toronto'")


    val meetup_rsvp_df_6 = meetup_rsvp_df_5.groupBy("group_name", "group_city", "group_lat", "group_lon", "response")
    ...
    val trans_detail_write_stream = meetup_rsvp_df_6
      .writeStream
